...
public class TaskRepository implements ITaskRepository {
    ...
    public Task create(Task task) {
        ...
        try {
            ...
            throw new DatabaseException("Database fejl: kunne ikke indsætte opgaven.", e);
        }
    ...
    public List<Task> readAll() {
        ...
        try {
            ...
            throw new DatabaseException("Database fejl: kunne ikke hente alle opgaver.", e);
        }
    }
    ...
    public Task readSelected(int id) {
        ...
        try {
            ...
            throw new DatabaseException("Database fejl: kunne ikke hente opgaven.", e);
        }
        return task.isEmpty()
                ? null
                : task.getFirst();
    ...
    public boolean delete(int id) {
        ...
        try {
            ...
            throw new DatabaseException("Fejl: kunne ikke slette opgaven.", e);
        }
    }
    ...
    public boolean update(Task newObject) {
        ...
        try {
            ...
            throw new DatabaseException("Fejl: kunne ikke opdatere opgaven.");
        }
    }
    ...
    public List<Integer> getCurrentUserIdsFromUserTasks(int taskId) {
        try {
            ...
            throw new DatabaseException("Fejl: kunne ikke hente brugerid'er til opgaven.", e);
        }
    }
